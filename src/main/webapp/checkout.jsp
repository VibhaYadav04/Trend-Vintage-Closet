	...
	<div class="container">
		<div class="row p-2">
				...
				<div class="card bg-white">
					<div class="card-body">
						...
						<table class="table table-striped">
							...
							List<Cart> cart = dao.getClothByUser(u.getId());
							...
							%>
							<tr>
									<th scope="row"><%=c.getClothName() %></th>
									<td><%=c.getPrice() %></td>
									<td>
									<a href="remove_cloth?clothId=<%=c.getClothId() %>&&userId=<%=c.getUserId() %>&&cartId=<%=c.getCartId() %>" class="btn btn-danger">Remove</a>
									</td>
								</tr>
							<%
							}
			...
			<div class="col-md-6">
				<div class="card bg-white">
					<div class="card-body">
						<h3 class="text-center text-success">Enter Your Details for
							Order</h3>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Name</label> <input type="text" name="username"
										class="form-control" id="inputEmail" value="${userobj.name}" required>
								</div>
								<div class="form-group col-md-6">
